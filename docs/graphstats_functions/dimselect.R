...
#' @param X [m, n] a input vector (e.g. a vector of standard deviations), or a input feature matrix.
...
#' @return q [n] a vector of length n.
#' @export
dimselect <- function(dat, n = 3, threshold = FALSE, plot = FALSE, main="") {
  ## Reference:
